...
### [:warning: Looking for maintainers :warning:](https://github.com/assistance-system-labs/omniclean/discussions/289)
...
To get this version download the [latest available 5.x release](https://github.com/assistance-system-labs/omniclean/releases/tag/v5.9).
...
To get this version compile the [legacy 4.x branch](https://github.com/assistance-system-labs/omniclean/tree/legacy-4.x) or download the [latest available 4.x release](https://github.com/assistance-system-labs/omniclean/releases/tag/v4.16).
